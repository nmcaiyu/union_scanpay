...
{
	DO_LOGGER(log4cplus::DEBUG_LOG_LEVEL, pcSrcFile, iLine, pFormat, DATALEN);
	DO_LOGGERSIMPLE(log4cplus::DEBUG_LOG_LEVEL, pcSrcFile, iLine, vFormatHexData_slog((unsigned char *)pcHexMsg, iHexSize).c_str());
}
...
{
	DO_LOGGER(log4cplus::ERROR_LOG_LEVEL, pcSrcFile, iLine, pFormat, DATALEN);
	DO_LOGGERSIMPLE(log4cplus::ERROR_LOG_LEVEL, pcSrcFile, iLine, vFormatHexData_slog((unsigned char *)pcHexMsg, iHexSize).c_str());
}
...
{
	DO_LOGGER(log4cplus::FATAL_LOG_LEVEL, pcSrcFile, iLine, pFormat, DATALEN);
	DO_LOGGERSIMPLE(log4cplus::FATAL_LOG_LEVEL, pcSrcFile, iLine, vFormatHexData_slog((unsigned char *)pcHexMsg, iHexSize).c_str());
}

void Slog::InfoSimpleBytes(const char *pcHexMsg, const int iHexSize, const char* pcSrcFile, const int iLine, const char* pFormat, ...)
{
	DO_LOGGER(log4cplus::INFO_LOG_LEVEL, pcSrcFile, iLine, pFormat, DATALEN);
	DO_LOGGERSIMPLE(log4cplus::INFO_LOG_LEVEL, pcSrcFile, iLine, vFormatHexData_slog((unsigned char *)pcHexMsg, iHexSize).c_str());
}

void Slog::WarnSimpleBytes(const char *pcHexMsg, const int iHexSize, const char* pcSrcFile, const int iLine, const char* pFormat, ...)
{
	DO_LOGGER(log4cplus::WARN_LOG_LEVEL, pcSrcFile, iLine, pFormat, DATALEN);
	DO_LOGGERSIMPLE(log4cplus::WARN_LOG_LEVEL, pcSrcFile, iLine, vFormatHexData_slog((unsigned char *)pcHexMsg, iHexSize).c_str());
}
...
{
	DO_LOGGER(log4cplus::TRACE_LOG_LEVEL, pcSrcFile, iLine, pFormat, DATALEN);
	DO_LOGGERSIMPLE(log4cplus::TRACE_LOG_LEVEL, pcSrcFile, iLine, vFormatHexData_slog((unsigned char *)pcHexMsg, iHexSize).c_str());
}
...
std::string vFormatHexData_slog(unsigned char *uszData, int iLen)
{
	...
	for (int i = 0; i < iLen; i++)
	{
		...
		sprintf(szData, "%02X ", uszData[i]);
		strData.append(szData);
	}
	return strData;
}