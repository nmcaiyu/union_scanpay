...
int readIni()
{
    ...
    globalCFG.iHttpEnable = reader.GetInteger("info", "httpEnable", 0);
    strcpy(globalCFG.szSocketIp, reader.Get("info", "socketIp", "").c_str());
    globalCFG.iSocketPort = reader.GetInteger("info", "socketPort", 9000);
